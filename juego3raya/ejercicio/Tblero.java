...
*/    
    ...
    public Tblero(int limpiar){
        ...
        players.crearjugador(datos.getDatos().getTablero().getJugadores().get(0).getNombre(), datos.getDatos().getTablero().getJugadores().get(0).getFicha().charAt(0));
        players.crearjugador(datos.getDatos().getTablero().getJugadores().get(1).getNombre(), datos.getDatos().getTablero().getJugadores().get(1).getFicha().charAt(0));
        System.out.println("orden de jugadores para tres en raya");
        ...
        tamaño = datos.getDatos().getTablero().getTamaño();
...
{//inicio metodo buscarcoordenada
        ...
        System.out.println(players.turno_actual().getNombre()+"introduzca la posición para: "+i);
